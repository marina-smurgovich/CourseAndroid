...
class DialogCookingTime : DialogFragment() {
    fun newInstance(num: Int): DialogCookingTime {
        val dialogFragment = DialogCookingTime()
        val bundle = Bundle()
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val view = inflater.inflate(R.layout.dialog_cooking_time, null)
        return AlertDialog.Builder(activity)
                ...
                .setPositiveButton(R.string.add_keyword, object : DialogInterface.OnClickListener {
                    override fun onClick(dialog: DialogInterface?, whichButton: Int) {
                        ...
                        val intent = Intent()
                        intent.putExtra("DialogCookingTime", input)
